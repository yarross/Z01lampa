...
window.rch_nws[hostkey].Registry = function RchRegistry(client, startConnection) {
  ...
  function component(object) {
    ...
    this.parse = function(str) {
      ...
      try {
          ...
          if (videos.length) {
            if (buttons.length) {
              ...
              if (find_voice_url && !find_voice_url.active) {
                //console.log('Yarross', 'go to voice', find_voice_url);
                this.replaceChoice({
                ...
                //console.log('Yarross', 'go to voice', find_voice_name);
                this.replaceChoice({
            ...
            if (similar.length) {
              ...
              //console.log('Yarross', 'go to season', season);
        ...
        //console.log('Yarross', 'error', e.stack);
    ...
    var source = {
      ...
      onSelect: function(params, close) {
        ...
        Lampa.Activity.push({
          ...
          title: 'Yarross - ' + params.element.title,
          component: 'lampac_z',
  ...
  function startPlugin() {
    ...
    var manifst = {
      ...
      version: '',
      name: 'Yarross',
      description: 'Yarross — Онлайн видео',
      component: 'lampac_z',
